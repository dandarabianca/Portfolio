      ...
      <div className="projects-card">
        <div className="styles.conhec">
          ...
          <div className="card">
            ...
            <a href="https://lista-de-tarefas-dandara.netlify.app/" target="_blank">Ver projetos</a>
          </div>
          ...
          <div className="card">
            ...
            <a href="https://sitelandingpage.netlify.app/#contact" target="_blank">Ver projetos</a>
          </div>
        </div>
      </div>
    </section>
